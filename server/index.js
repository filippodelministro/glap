  ...
  async (req, res) => {
    ...
    try {
      ...
      const newFilm = {
        ...
        // favorite === undefined must be distinguished from favorite === false
        favorite: req.body.favorite === undefined ? film.favorite : req.body.favorite,
        watchDate: req.body.watchDate || film.watchDate,
        rating: (req.body.rating !== null) ? req.body.rating : film.rating,
        user: req.user.id   // user is overwritten with the id of the user that is doing the request and it is logged in
      };
      //console.log('DEBUG: PUT newFilm: '+JSON.stringify(newFilm));
